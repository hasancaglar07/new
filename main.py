...
def get_all_authors():
    ...
    with ix.searcher() as s:
        authors_set = set(f['author'].title() for f in s.all_stored_fields() if 'author' in f)
...
# Not: Diğer tüm endpoint'leriniz (video arama, video analizi vb.) bu dosyanın devamında yer almalıdır.